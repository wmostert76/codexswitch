...
for command in openswitch codexswitch codex-provider-proxy codexswitch-azure-token codexswitch-claude-token codexswitch-provider-credential codex-opencode-go-proxy codex-openrouter-proxy codex-azure-proxy opencode-go-token openrouter-token; do
